<template>
    <div class="bg-white rounded-lg shadow w-2/3 p-4">
        <div class="flex justify-between items-center">
            ...
            <div class="flex-1 mx-4">
                <input type="text" name="post" class="w-full h-8 pl-4 bg-gray-200 rounded-full focus:outline-none focus:shadow-outline"
